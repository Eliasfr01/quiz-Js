const htmlQuestions = [
  ...
  {
    question:
      "Qual atributo HTML é usado para identificar elementos unicamente em uma página?",
  ...
  {
    question:
      "Qual atributo HTML é usado para especificar o texto exibido quando o elemento não é renderizado corretamente?",
    options: ["<alt>", "<title>", " <placeholder>", "<tooltip>"],
    correctAnswer: "<alt>",
  },
  {
    question:
      "Qual é a estrutura correta para criar uma célula de cabeçalho em uma tabela?",
    options: ["<td>", "<tr>", "<th>", "<caption>"],
    correctAnswer: "<th>",
  },
  {
    question:
      "Qual tag HTML é usada para definir um campo de entrada de texto em um formulário?",
    options: [
      "<textarea>",
      "<input type=text>",
      "<input type=textarea>",
  ...
  {
    question:
      "Como você define um item selecionado por padrão em uma lista suspensa?",
    options: ["<default>", "<checked>", "<selected>", "<autofocus>"],
    correctAnswer: "<selected>",
  },
  {
    question:
      "Qual tag HTML é usada para inserir metadados sobre a página na seção <head>?",
    options: ["<link>", "<meta>", " <script>", "<style>"],
    correctAnswer: "<meta>",
  },
  {
    question:
      "Qual atributo deve ser usado para associar um rótulo <label> a um campo <input>?",
    options: ["<name>", "<for>", "<id>", "<value>"],
    correctAnswer: "<for>",
  },
  {
    question:
      "Qual é o propósito do atributo rel='noopener noreferrer' em um link?",
    options: [
      "<Previne problemas de segurança ao abrir links em nova aba.>",
      "<Ativa o redirecionamento automático.>",
      "<Define o tipo de conteúdo esperado pelo navegador.>",
      "<Desabilita o link.>",
    ],
    correctAnswer:
      "<Previne problemas de segurança ao abrir links em nova aba.>",
  },
  {
    ...
    options: [
      ...
      "<Criar slideshows de imagens automaticamente>",
      "< Fornecer diferentes fontes de imagem para dispositivos variados>",
      "<Permitir a edição de imagens diretamente no navegador>",
    ],
    correctAnswer:
      "<Fornecer diferentes fontes de imagem para dispositivos variados>",
  },
  {
    question:
      "Como você cria um campo de formulário que permite múltiplos arquivos serem enviados?",
    options: [
      "<input type='multiple-files'>",
      "<input type='file' multiple>",
      "<input type='upload' multiple>",
      "<input type='file' multiselect>",
    ],
  ...
  {
    question:
      "Qual atributo é usado para fornecer um texto alternativo para uma imagem?",
...
const cssQuestions = [
  {
    question:
      "Qual é a propriedade CSS usada para mudar a cor de fundo de um elemento?",
    options: ["background-color", "bgcolor", "color", "back-color"],
    correctAnswer: "background-color",
  },
  {
    question:
      "Qual é a sintaxe correta para adicionar uma cor de texto em CSS?",
    options: [
      "color: black;",
      "text-color: black;",
      "font-color: black;",
  ...
  {
    question:
      "Qual é a propriedade CSS usada para alterar o tamanho da fonte de um elemento?",
    options: ["font-size", "text-size", "font-height", "text-height"],
    correctAnswer: "font-size",
  },
  {
    question:
      "Qual propriedade CSS é usada para adicionar espaço interno dentro de um elemento?",
    options: ["margin", "padding", "spacing", "border"],
    correctAnswer: "padding",
  },
  {
    question:
      "Qual é a sintaxe correta para fazer todos os <p> elementos terem texto centralizado?",
    options: [
      "p {text-align: center;}",
      "p {align: center;}",
      "p {text-center: true;}",
  ...
  {
    question:
      "Qual propriedade CSS é usada para mudar a cor da borda de um elemento?",
    options: [
      "border-color",
      "border-style",
      "border-width",
...
const jsQuestions = [
  ...
  {
    question:
      'Qual é o valor de x após executar o código abaixo\n "let x = 10; x += 5; "?',
    options: ["<10>", "<15>", "<5>", "<Undefined>"],
    correctAnswer: "<15>",
  },
  {
    question:
      'O que o seguinte código retorna?\n"console.log(typeof "Texto");"',
  ...
  {
    question:
      'Qual será a saída do seguinte código "let a = "10;"\n "let b = 10;"\n"console.log(a === b); "?"',
    options: ["<true>", "<false>", "<undefined>", "<null>"],
    correctAnswer: "<false>",
  },
  {
  ...
  {
    question:
      'Qual é o valor da variável resultado após executar o código?\n "let resultado = 5 > 3 ? "Maior" : "Menor";"',
    options: ["<Maior>", "<Menor>", "<Undefined>", "<null>"],
    correctAnswer: "<Maior>",
  },
  {
    question:
      'O que o seguinte código imprime no console?\n "let obj = { nome: "João", idade: 25 };\nconsole.log(Object.keys(obj)); "',
...
function loadQuestion() {
  if (currentQuestionIndex >= allQuestions.length) {
    document.getElementById(
      "question"
    ).textContent = `Quiz concluído! Sua pontuação final é ${score} de ${allQuestions.length}.`;
    document
  ...
  document.getElementById("num-question").textContent = `Pergunta ${
...
function storeModuleAndRedirect(module) {
  sessionStorage.setItem("selectedModule", module);
  window.location.href = "perguntas.html";
}

document.addEventListener("DOMContentLoaded", () => {
  const module = sessionStorage.getItem("selectedModule");
  if (module) {
    startQuiz(module);
  } else {
    document.getElementById("moduleSelection").style.display = "block";
